...
resource "aws_iam_role" "ecs_scaler" {
...
resource "aws_iam_role_policy" "ecs_scaler" {
  name = "${var.project_name}-ecs-scaler-policy"
  role = aws_iam_role.ecs_scaler.id
...
# Additional EMR EC2 policies for Iceberg, S3, Glue, MSK
